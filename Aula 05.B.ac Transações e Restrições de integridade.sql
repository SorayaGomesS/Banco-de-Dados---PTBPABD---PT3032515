...
CREATE TABLE avaliacaocontinua.employee_ac (
...
CREATE TABLE avaliacaocontinua.manages_ac (
    person_name VARCHAR(100) NOT NULL PRIMARY KEY,
...
REFERENCES avaliacaocontinua.employee_ac(person_name)
ON UPDATE CASCADE
ON DELETE CASCADE;
...
ALTER TABLE avaliacaocontinua.manages_ac
